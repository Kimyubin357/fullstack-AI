...
var articlesAPIRouter = require('./routes/api/articlesAPI');//routes 라우터 추가
...
app.use((req,res,next)=>{
  //여기에 모든 사용자의 요청이 있을 때마다 실행되어야 하는 기능을 구현했습니다.
...
//만약에 사용자가 http://localhost:3000/user/eddy 라는 주소를 요청해오면
...
//articleAPIRouter의 기본 호출 주소 체계정의 허가
